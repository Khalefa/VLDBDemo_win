...
int  STL::stl_(double *y, int *n, int *np, int *ns,
...
L100:
    STL::stlstp_(&y[1], n, &newnp, &newns, &newnt, &newnl, isdeg, itdeg, ildeg, 
...
/* L15: */
 ...
 int STL::stless_(double *y, int *n, int *len, int 
...
/* L55: */
 ...
 int STL::stlest_(double *y, int *n, int *len, int 
...
/* L81: */
 ...
 int  STL::stlfts_(double *x, int *n, int *np, 
	double *trend, double *work)
{
 ...
 int STL::stlma_(double *x, int *n, int *len, 
	double *ave)
{
    /* System generated locals */
    int i__1;
...
/* L7: */
 ...
 int STL::stlstp_(double *y, int *n, int *np, int *
...
/* L80: */
 ...
 int STL::stlrwt_(double *y, int *n, double *fit, 
	double *rw)
{
    /* System generated locals */
    int i__1;
...
/* L10: */
 ...
 int STL::stlss_(double *y, int *n, int *np, int *
...
/*  STL E_Z_ : "Easy" user interface  -- not called from R */
 int STL::stlez_(double *y, int *n, int *np, int *
...
/* L150: */
 ...
 int STL::psort_(double *a, int *n, int *ind, int *
	ni)
{
...
void STL::compute(double *x, int n, int period, int s_window, double *trend, double *season){
	int s_degree = 0;
	int t_degree = 1;
